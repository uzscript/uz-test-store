...
async function validateTurboNextConfig({ dir, isDev }) {
    const { getPkgManager } = require('next/dist/lib/helpers/get-pkg-manager');
    const { getBabelConfigFile } = require('next/dist/build/get-babel-config-file');
    const { defaultConfig } = require('next/dist/server/config-shared');
    const { bold, cyan, red, underline } = require('next/dist/lib/picocolors');
    const { interopDefault } = require('next/dist/lib/interop-default');
