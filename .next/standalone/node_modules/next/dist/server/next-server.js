...
0 && __export(require("next/dist/server/base-server"));
require("next/dist/server/node-environment");
require("next/dist/server/require-hook");
require("next/dist/server/node-polyfill-crypto");
const _utils = require("next/dist/shared/lib/utils");
const _fs = /*#__PURE__*/ _interop_require_default(require("fs"));
const _path = require("path");
const _routematcher = require("next/dist/shared/lib/router/utils/route-matcher");
const _requestmeta = require("next/dist/server/request-meta");
const _constants = require("next/dist/shared/lib/constants");
const _findpagesdir = require("next/dist/lib/find-pages-dir");
const _node = require("next/dist/server/base-http/node");
const _sendpayload = require("next/dist/server/send-payload");
const _parseurl = require("next/dist/shared/lib/router/utils/parse-url");
const _log = /*#__PURE__*/ _interop_require_wildcard(require("next/dist/build/output/log"));
const _baseserver = /*#__PURE__*/ _interop_require_wildcard(_export_star(require("next/dist/server/base-server"), exports));
const _require = require("next/dist/server/require");
const _denormalizepagepath = require("next/dist/shared/lib/page-path/denormalize-page-path");
const _normalizepagepath = require("next/dist/shared/lib/page-path/normalize-page-path");
const _loadcomponents = require("next/dist/server/load-components");
const _iserror = /*#__PURE__*/ _interop_require_wildcard(require("next/dist/lib/is-error"));
const _utils1 = require("next/dist/server/web/utils");
const _middlewareroutematcher = require("next/dist/shared/lib/router/utils/middleware-route-matcher");
const _env = require("@next/env");
const _querystring = require("next/dist/shared/lib/router/utils/querystring");
const _removetrailingslash = require("next/dist/shared/lib/router/utils/remove-trailing-slash");
const _getnextpathnameinfo = require("next/dist/shared/lib/router/utils/get-next-pathname-info");
const _bodystreams = require("next/dist/server/body-streams");
const _apiutils = require("next/dist/server/api-utils");
const _responsecache = /*#__PURE__*/ _interop_require_wildcard(require("next/dist/server/response-cache"));
const _incrementalcache = require("next/dist/server/lib/incremental-cache");
const _apppaths = require("next/dist/shared/lib/router/utils/app-paths");
const _setuphttpagentenv = require("next/dist/server/setup-http-agent-env");
const _pagesapiroutematch = require("next/dist/server/route-matches/pages-api-route-match");
const _constants1 = require("next/dist/lib/constants");
const _tracer = require("next/dist/server/lib/trace/tracer");
const _constants2 = require("next/dist/server/lib/trace/constants");
const _nodefsmethods = require("next/dist/server/lib/node-fs-methods");
const _routeregex = require("next/dist/shared/lib/router/utils/route-regex");
const _pipereadable = require("next/dist/server/pipe-readable");
const _mockrequest = require("next/dist/server/lib/mock-request");
const _approuterheaders = require("next/dist/client/components/app-router-headers");
const _nextrequest = require("next/dist/server/web/spec-extension/adapters/next-request");
const _routemoduleloader = require("next/dist/server/lib/module-loader/route-module-loader");
const _loadmanifest = require("next/dist/server/load-manifest");
const _modulerender = require("next/dist/server/route-modules/app-page/module.render");
const _modulerender1 = require("next/dist/server/route-modules/pages/module.render");
const _interopdefault = require("next/dist/lib/interop-default");
const _formatdynamicimportpath = require("next/dist/lib/format-dynamic-import-path");
const _generateinterceptionroutesrewrites = require("next/dist/lib/generate-interception-routes-rewrites");
const _routekind = require("next/dist/server/route-kind");
const _invarianterror = require("next/dist/shared/lib/invariant-error");
const _awaiter = require("next/dist/server/after/awaiter");
const _asynccallbackset = require("next/dist/server/lib/async-callback-set");
...
class NextNodeServer extends _baseserver.default {
    constructor(options){
        ...
        super(options), this.registeredInstrumentation = false, this.cleanupListeners = new _asynccallbackset.AsyncCallbackSet(), this.handleNextImageRequest = async (req, res, parsedUrl)=>{
            ...
            // the `else` branch is needed for tree-shaking
                ...
                const { sendResponse, ImageError } = require('next/dist/server/image-optimizer');
                ...
                try {
                    ...
                    const { getExtension } = require('next/dist/server/serve-static');
            ...
            try {
                ...
                try {
                    if (this.renderOpts.dev) {
                        const { formatServerError } = require('next/dist/lib/format-server-error');
    ...
    async imageOptimizer(req, res, paramsResult, previousCacheEntry) {
        if (process.env.NEXT_MINIMAL) {
            ...
            const { imageOptimizer, fetchExternalImage, fetchInternalImage } = require('next/dist/server/image-optimizer');
