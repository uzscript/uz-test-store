...
const _configshared = require("next/dist/server/config-shared");
const _configutils = require("next/dist/server/config-utils");
const _imageconfig = require("next/dist/shared/lib/image-config");
const _env = require("@next/env");
const _flushandexit = require("next/dist/telemetry/flush-and-exit");
const _findroot = require("next/dist/lib/find-root");
...
const _matchremotepattern = require("next/dist/shared/lib/match-remote-pattern");
const _ciinfo = require("next/dist/server/ci-info");
const _transpileconfig = require("next/dist/build/next-config-ts/transpile-config");
const _dset = require("next/dist/shared/lib/dset");
const _zod = require("next/dist/shared/lib/zod");
...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (!((_process_env___NEXT_VERSION = "15.1.6") == null ? void 0 : _process_env___NEXT_VERSION.includes('canary')) && !process.env.__NEXT_TEST_MODE && !process.env.NEXT_PRIVATE_SKIP_CANARY_CHECK) {
