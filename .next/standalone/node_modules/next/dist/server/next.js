...
const _formaturl = require("next/dist/shared/lib/router/utils/format-url");
...
const getServerImpl = async ()=>{
    if (ServerImpl === undefined) {
        ServerImpl = (await Promise.resolve(require('next/dist/server/next-server'))).default;
    }
    return ServerImpl;
};
...
class NextServer {
    ...
    async createServer(options) {
        ...
        if (options.dev) {
            ServerImplementation = require('next/dist/server/dev/next-dev-server').default;
        } else {
...
function createServer(options) {
    ...
    if (options && 'typescript' in options && 'version' in options.typescript) {
        return require('next/dist/server/next-typescript').createTSPlugin(options);
    }
    if (options == null) {
