...
const _output = require("next/dist/build/output");
const _constants = require("next/dist/lib/constants");
const _findpagesdir = require("next/dist/lib/find-pages-dir");
const _constants1 = require("next/dist/shared/lib/constants");
const _nextserver = /*#__PURE__*/ _interop_require_wildcard(require("next/dist/server/next-server"));
const _normalizepagepath = require("next/dist/shared/lib/page-path/normalize-page-path");
const _pathhasprefix = require("next/dist/shared/lib/router/utils/path-has-prefix");
const _removepathprefix = require("next/dist/shared/lib/router/utils/remove-path-prefix");
const _storage = require("next/dist/telemetry/storage");
const _trace = require("next/dist/trace");
const _findpagefile = require("next/dist/server/lib/find-page-file");
const _utils = require("next/dist/server/lib/utils");
const _coalescedfunction = require("next/dist/lib/coalesced-function");
const _loaddefaulterrorcomponents = require("next/dist/server/load-default-error-components");
const _utils1 = require("next/dist/shared/lib/utils");
...
const _utils2 = require("next/dist/build/utils");
const _formatservererror = require("next/dist/lib/format-server-error");
const _devroutematchermanager = require("next/dist/server/route-matcher-managers/dev-route-matcher-manager");
const _devpagesroutematcherprovider = require("next/dist/server/route-matcher-providers/dev/dev-pages-route-matcher-provider");
const _devpagesapiroutematcherprovider = require("next/dist/server/route-matcher-providers/dev/dev-pages-api-route-matcher-provider");
const _devapppageroutematcherprovider = require("next/dist/server/route-matcher-providers/dev/dev-app-page-route-matcher-provider");
const _devapprouteroutematcherprovider = require("next/dist/server/route-matcher-providers/dev/dev-app-route-route-matcher-provider");
const _nodemanifestloader = require("next/dist/server/route-matcher-providers/helpers/manifest-loaders/node-manifest-loader");
const _batchedfilereader = require("next/dist/server/route-matcher-providers/dev/helpers/file-reader/batched-file-reader");
const _defaultfilereader = require("next/dist/server/route-matcher-providers/dev/helpers/file-reader/default-file-reader");
const _lrucache = require("next/dist/server/lib/lru-cache");
const _middlewareroutematcher = require("next/dist/shared/lib/router/utils/middleware-route-matcher");
const _detachedpromise = require("next/dist/lib/detached-promise");
const _ispostpone = require("next/dist/server/lib/router-utils/is-postpone");
const _generateinterceptionroutesrewrites = require("next/dist/lib/generate-interception-routes-rewrites");
const _buildcustomroute = require("next/dist/lib/build-custom-route");
const _errorsource = require("next/dist/shared/lib/error-source");
const _logrequests = require("next/dist/server/dev/log-requests");
const _fallback = require("next/dist/lib/fallback");
...
const ReactDevOverlay = (props)=>{
    if (ReactDevOverlayImpl === undefined) {
        ReactDevOverlayImpl = require('next/dist/client/components/react-dev-overlay/pages/client').ReactDevOverlay;
    }
