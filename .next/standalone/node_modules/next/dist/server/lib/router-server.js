...
const _config = /*#__PURE__*/ _interop_require_default(require("next/dist/server/config"));
const _servestatic = require("next/dist/server/serve-static");
...
const _filesystem = require("next/dist/server/lib/router-utils/filesystem");
const _proxyrequest = require("next/dist/server/lib/router-utils/proxy-request");
const _pipereadable = require("next/dist/server/pipe-readable");
const _resolveroutes = require("next/dist/server/lib/router-utils/resolve-routes");
...
const _baseserver = require("next/dist/server/base-server");
...
const _redirectstatuscode = require("next/dist/client/components/redirect-status-code");
const _devbundlerservice = require("next/dist/server/lib/dev-bundler-service");
const _trace = require("next/dist/trace");
const _ensureleadingslash = require("next/dist/shared/lib/page-path/ensure-leading-slash");
const _getnextpathnameinfo = require("next/dist/shared/lib/router/utils/get-next-pathname-info");
const _gethostname = require("next/dist/shared/lib/get-hostname");
const _detectdomainlocale = require("next/dist/shared/lib/i18n/detect-domain-locale");
const _mockrequest = require("next/dist/server/lib/mock-request");
const _hotreloadertypes = require("next/dist/server/dev/hot-reloader-types");
const _normalizedassetprefix = require("next/dist/shared/lib/normalized-asset-prefix");
const _patchfetch = require("next/dist/server/lib/patch-fetch");
const _utils1 = require("next/dist/server/lib/server-ipc/utils");
...
async function initialize(opts) {
    ...
    renderServer.instance = require('next/dist/server/lib/render-server');
    const requestHandlerImpl = async (req, res)=>{
        ...
        if (!opts.minimalMode && config.i18n && config.i18n.localeDetection !== false) {
            ...
            const { getLocaleRedirect } = require('next/dist/shared/lib/i18n/get-locale-redirect');
